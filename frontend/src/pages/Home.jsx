      ...
      <section className="relative overflow-hidden pt-16 pb-20 lg:pt-24 lg:pb-32">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            {/* 4. Secondary Button - Added glassmorphism for Dark Mode */}
            <Link to="/signup" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white dark:bg-slate-900/50 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-800 px-8 py-4 rounded-2xl font-bold hover:bg-slate-50 dark:hover:bg-slate-800 backdrop-blur-sm transition-all shadow-sm">
              Join ShopEasy
            </Link>
          </div>
        </div>
