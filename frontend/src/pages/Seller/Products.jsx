                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="p-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-xl hover:bg-orange-500 hover:text-white transition-all shadow-sm"
                      title="Edit Product"
                    >
                      <Edit3 size={18} />
                    </button>
                    <button
                      ...
                      className="p-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-xl hover:bg-red-500 hover:text-white transition-all shadow-sm"
