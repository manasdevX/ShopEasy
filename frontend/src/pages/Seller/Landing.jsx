      ...
      <section className="bg-slate-50 dark:bg-slate-900/30 py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
          <BenefitCard
            ...
            desc="Get paid directly into your bank account every 24 hours."
          />
          <BenefitCard
            icon={<TrendingUp size={32} />}
            title="Powerful Analytics"
            desc="Track your sales and growth with our advanced dashboard."
          />
          <BenefitCard
            icon={<ShoppingBag size={32} />}
            title="Zero Setup Fee"
            desc="Start listing your products for free with no hidden charges."
          />
        </div>
      </section>
