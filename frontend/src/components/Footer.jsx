        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
              Your one-stop destination for the latest electronics, fashion, and
              lifestyle essentials. Quality products, delivered fast.
            </p>
          ...
          {/* Column 2: Quick Shop */}
          <div>
            <h3 className="text-slate-900 dark:text-white font-bold mb-6 text-sm uppercase tracking-wider">
              Shop
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
              ...
              <li>
                <FooterLink to="/account?tab=orders" label="Track Order" />
              </li>
...
function SocialIcon({ icon }) {
  return (
    <a
      href="#"
      className="w-9 h-9 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-500 dark:hover:text-white transition-all shadow-sm"
    >
      {icon}
    </a>
  );
